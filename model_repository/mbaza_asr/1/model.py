...
LOCAL_NEMO_PATH = os.path.join(os.path.dirname(__file__), "nemo_model")
MBAZA_ASR_HUGGINGFACE = os.getenv("MBAZA_ASR")
    ...
    def initialize(self, args):
        ...
        if os.path.isfile(LOCAL_NEMO_PATH):
            ...
            try:
                ...
                print("Set the HF_TOKEN in the compose file")
            ...
            print(f"No local checkpoint found, try downloading from huggingface ...")
            self.model = nemo_asr.models.ASRModel.from_pretrained(MBAZA_ASR_HUGGINGFACE)
